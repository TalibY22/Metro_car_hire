						...
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
						  ...
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img class="d-block w-100" src="images/image5-1920x700.jpg" alt="First slide">
						    </div>
						    <div class="carousel-item">
						      <img class="d-block w-100" src="images/image7-1920x700.jpg" alt="Second slide">
						    </div>
						    <div class="carousel-item">
						      <img class="d-block w-100" src="images/image6-1920x700.jpg" alt="Third slide">
						    </div>
						  </div>
					...
					<footer id="footer">
						<div class="inner">
							...
							<section>
								...
								<ul class="alt">
									<li><span class="fa fa-envelope-o"></span> <a href="#">contact@metrocargmail.com</a></li>
									<li><span class="fa fa-phone"></span> +1 254 </li>
									<li><span class="fa fa-map-pin"></span> 212 parklands nairobi kenya</li>
								</ul>
							...
							<ul class="copyright">
								<li>Copyright © 2024 metro car hire </li>
								<li>Template by: <a href="https://www.metro car hire/">metro car hire</a></li>
							</ul>
						</div>
					</footer>
